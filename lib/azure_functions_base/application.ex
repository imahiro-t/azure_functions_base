defmodule AzureFunctionsBase.Application do
  ...
  def start(_type, _args) do
    ...
    idle_timeout = context |> Map.get("IDLE_TIMEOUT", "300_000") |> String.to_integer
    children = [
      {Logger, context |> Map.get("LOG_LEVEL", "INFO") |> String.downcase |> String.to_atom},
      {Plug.Cowboy, scheme: :http, plug: AzureFunctionsBase.Base, options: [port: port, protocol_options: [idle_timeout: idle_timeout]]},
    ]
